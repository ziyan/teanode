...
| `teanode agent knowledge list\|add\|pause\|resume\|sync\|allow\|remove` | the places your agent reads: `add "work" ~/work --computer laptop --under work`, `sync` reads one again now, `pause` keeps what it found |
