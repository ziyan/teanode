...
| `teanode calendar calendars\|set` | the calendars themselves: what they are called, what a client paints them, and the zone a new event is written in — `set --timezone Europe/Berlin` |
