...
it('keeps another answer disabled until the confirmed change has refreshed', async () => {
  fixture.send.mockResolvedValue(undefined)
  ...
  const decline = screen.getByRole('button', { name: 'invitation.decline' }) as HTMLButtonElement
