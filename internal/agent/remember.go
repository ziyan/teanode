...
//
// The words alone are not enough, and believing they were lost events. An
// annual inspection completed in 2024 and the same inspection completed in
// 2025 are written in the same words by anybody describing them, and this
// path does not write the second row at all -- so the newer occurrence was
// not folded behind the older, which would at least have kept it. It was
// never filed, and the page went on saying the older date.
//
// So the kind has to agree, and when both say when they happened, that has
// to agree too.
//
